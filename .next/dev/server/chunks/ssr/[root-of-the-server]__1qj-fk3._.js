...
"[project]/app/lib/api/index.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:9669";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/api/index.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
function ChatBox() {
    ...
    const sendMessage = async ()=>{
        ...
        setConnected(true);
        try {
            const response = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["endpoints"].chat, {
                method: "POST",
                headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1qj-fk3._.js.map