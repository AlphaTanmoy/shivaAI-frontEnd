...
"[project]/app/lib/api/index.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:9669";
const getWebSocketUrl = ()=>{
    const configuredUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_WS_URL?.trim();
    if (configuredUrl) {
        return configuredUrl;
    }
    const baseUrl = (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || API_BASE_URL).trim();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/lib/api/index.ts [app-client] (ecmascript)");
;
...
function ChatBox() {
    ...
    const sendMessage = async ()=>{
        ...
        setConnected(true);
        try {
            const response = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["endpoints"].chat, {
                method: "POST",
                headers: {
            ...
            setMessages((prev)=>[
                    ...
                    {
                        role: "bot",
                        text: "Sorry, I couldn’t reach the chat service right now."
                    }
                ]);
        } finally{
            setLoading(false);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: connectionError ?? (loading ? "Sending..." : "Connected")
                            }, void 0, false, {
                                fileName: "[project]/app/components/ChatBox.tsx",
                                lineNumber: 108,
                                columnNumber: 11
...
_s(ChatBox, "UWgpL3aCM5DIsW/ZyDHQz88nv2w=");
_c = ChatBox;
var _c;
...
//# sourceMappingURL=app_0z6mlc-._.js.map